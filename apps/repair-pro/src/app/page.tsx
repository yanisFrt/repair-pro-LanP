...
// Assurez-vous que les imports suivants sont corrects pour votre structure de projet
...
const features = [
  ...
  },
  {
    ...
    title: "Évolution & Support Continu",
    description:
      "Bénéficiez de mises à jour mensuelles et d'un support réactif. Votre outil s&apos;améliore, votre entreprise grandit.",
  },
];

export default function RepairProLanding() {
  ...
  // Fonction pour ouvrir la modale avec le bon plan
